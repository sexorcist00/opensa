...
| 08-07 | [mobile-district-inventory](opensa-engine/2026-08-07-mobile-district-inventory.json) | dispatch console, `?inventory=1`, streamed district pak (`23:12 07-08-2026`, rect 9,-7,10,-6 Ganton) | **Mali-G51 / Android 10**, 360x364 CSS px @ DPR 2. FIRST real-world mobile row on a streamed SA district — supersedes the synthetic 08-04 row. 2482 frames / 209 s, `warnings` empty. No `timestamp-query`, so GPU time is ABSENT; `spans` empty (static camera, 4 resident cells). Taken on Ganton, **not** on 098/1-01's pinned `los-santos-centre`. | **31 fps** · p50 31.8 ms · p95 51.3 ms · submit 1.78 ms (5.6 % of frame) · cells 4/4 · draws 121 · **resident 239 MB** |
