...
| 2026-08-21 | [2026-08-21-lod-trees-impostor-bake.md](2026-08-21-lod-trees-impostor-bake.md) | lod-trees-generator | Plan 013 step 01: the supersampled, mip-aware card bake — speckle 6.0 → 1.1 % and 3.6 → 0.4 % with the canopy MASS unchanged, DXT5 edge error 26 → 10, bake ×7.1 (stage ~2 → ~9–10 min) |
