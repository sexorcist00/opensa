...
| 2026-08-17 | [2026-08-17-model-repack-lod-half.md](2026-08-17-model-repack-lod-half.md) | model-repack | plan 103: the OpenSA one-model swap gains its LOD half — gostown one cell 1.9 s (LOD rebake 1.2 s), lab LOD cut from the swapped HD (md5 proof), the all-archives source fix |
