...
| `CPool<CDummy>` | 2 500 | **`Dummys = 100000`** (raised from 50 000 in the field 2026-08-19 — the build places 17 539 permanent dummies against stock's 40, and the pool was exhausted on the third world entry) | OLA |
