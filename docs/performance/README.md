...
| [Multi-ray camera collision + On Top](deferred-optimizations/camera-multiray-collision.md) | correctness (camera feel) | multi-ray kills city-driving jitter (ignore poles, react to full occlusion); On Top pin fallback still reserved | multi-ray **PULLED 2026-07-25** (~<0.05 ms); On Top in reserve |
