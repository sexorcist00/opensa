...
| [Multi-ray camera collision](deferred-optimizations/camera-multiray-collision.md) | correctness (camera feel) | kills city-driving jitter (ignore poles, react to full occlusion); + On Top pin fallback | in reserve — 4+centre rays, ~<0.05 ms |
