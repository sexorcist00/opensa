...
- [ ] **v2 DIRECTIONAL — BUILT AND FIELD-REVERTED (2026-07-12), DEFERRED → [ideas/0.5.0/03-baked-directional-shadows](../../ideas/0.5.0/plans/03-baked-directional-shadows/readme.md)** (user decision; the ideas doc carries the full attempt/problem/solution record and the receiver-densification prerequisite): with the fixed-azimuth arc, per-vertex visibility is a THRESHOLD
