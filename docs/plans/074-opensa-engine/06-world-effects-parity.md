...
| --- | ------------------------------------------------------- | ------------------------------------------- | ---------------------------------------------------- | ----- | ------ |
| 1   | Prelit day↔night blend (uDn)                            | vertex channels + frame UBO                 | shipped bake + 073 TSL                               |       |        |
| 2   | World tints (day arc / night-prelit)                    | frame UBO                                   | canvas-host drive (exists)                           |       |        |
| 3   | Hybrid sun (indirect prelit + N·L direct, uPipelineMix) | world WGSL                                  | 073 world-material-tsl                               |       |        |
| 4   | Sky: PBR dome + horizon LUT                             | compute LUT (512×32) + sky pass             | sky.plugin math + pbrSkyParams (pure TS twin exists) |       |        |
| 5   | Unified LUT fog + horizon cut + height                  | world WGSL sampling the LUT                 | GLSL FOG_FRAGMENT (ported once already)              |       |        |
