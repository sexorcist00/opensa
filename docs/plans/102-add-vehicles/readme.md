...
| [`tools/add-vehicles/docs/plans/`](../../../tools/add-vehicles/docs/plans/readme.md) `001`–`007` | the new tool: resolver root, ids + rows + IMG, name/sound/parking, traffic, derived tuning, tuned traffic, pipeline + field | 001–003 **BUILT**, 004–007 planned |
