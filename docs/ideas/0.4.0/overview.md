...
| [02 — Rendering overhaul](../../plans/062-rendering-overhaul/readme.md) _(moved to `docs/plans/062–072`)_           | 10            | Look      | —        | ✅ standalone (but its perf harness is shared — see below) |
