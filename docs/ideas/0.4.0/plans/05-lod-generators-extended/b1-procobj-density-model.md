...
Part of [05 — LOD generators, extended](readme.md), Part B. The foundation for "more procobj": turn density from a hardcoded vanilla constant into a configurable, per-category/per-surface model. Depends on nothing to BUILD, but shipping raised density needs [B3](b3-budget-lift-integration.md)'s budget lift (Task 3).
