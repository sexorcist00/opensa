...
| ~~MOVED~~ | [sa-lod-generator/01 — adopt](sa-lod-generator/01-adopt-2dfx-policy.md) | **Superseded by [plan 100 step 05](../../../../plans/100-2dfx-at-lod-range/05-sa-clone-parity.md)**, which does the same adoption plus the carrying half of `02`. The file stays as the record of how it was scoped here. |
...
| [sa-lod-generator/01](sa-lod-generator/01-adopt-2dfx-policy.md) | verbatim + decimate paths routed through the policy, output byte-identical | lod-common/01 | **MOVED** → [plan 100/05](../../../../plans/100-2dfx-at-lod-range/05-sa-clone-parity.md) |
| [sa-lod-generator/02](sa-lod-generator/02-particle-emitters.md) | emitters on the DECIMATE path + the far-view budget (verbatim already ships) | none | **SPLIT** — the carry went to [plan 100/05](../../../../plans/100-2dfx-at-lod-range/05-sa-clone-parity.md); the far-view BUDGET stays here |
