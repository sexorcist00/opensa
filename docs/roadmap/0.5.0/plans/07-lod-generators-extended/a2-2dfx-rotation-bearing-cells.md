...
Part of [07 — LOD generators, extended](readme.md), Part A. Depends on [A1](a1-2dfx-unified-carry.md) (the unified policy). Delivers the "and the rest" — 2dfx types that today can't ride a baked cell because they carry orientation, not just a position.
