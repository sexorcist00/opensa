...
Part of [07 — LOD generators, extended](readme.md), Part A. The foundation: make the 2dfx carry policy ONE thing, applied identically and correctly across the three LOD representations, before adding new entry types (A2) or emitters (A3).
