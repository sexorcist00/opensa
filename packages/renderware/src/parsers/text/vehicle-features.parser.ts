 ...
 * long gone by the time a `.osm` is built. It is a BUILD-time input; nothing reads it at runtime, so a car
 * loaded through the modloader path gets only what its geometry itself says.
 */
