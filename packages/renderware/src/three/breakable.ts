...
import { breakableInstanceKey } from '../breakable/key';
import { breakableFromGeometry, getBreakable } from '../breakable/mesh';

export { breakableFromGeometry, breakableInstanceKey, getBreakable };
