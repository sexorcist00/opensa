  ...
  describe('positive cases', () => {
    ...
    it('builds deterministically and emits the committed listing (the review surface)', () => {
      ...
      expect(first.listing).toMatchInlineSnapshot(`
        ...
        000253: 004D GOTO_IF_FALSE -310
        000260: 02E7 START_CUTSCENE
        000262: 016A DO_FADE 1000 1
        000269: 0006 SET_LVAR_INT 32@ 0
        000276: 00D6 IF 1
        000280: 02E9 NOT HAS_CUTSCENE_FINISHED
        000282: 0019 NOT IS_INT_LVAR_GREATER_THAN_NUMBER 32@ 300000
        000292: 004D GOTO_IF_FALSE -310
        000299: 0001 WAIT 0
        000303: 0002 GOTO -276
        000310: 016A DO_FADE 0 0
        000316: 02EA CLEAR_CUTSCENE
        000318: 02EB RESTORE_CAMERA_JUMPCUT
        000320: 0373 SET_CAMERA_BEHIND_PLAYER
        000322: 04BB SET_AREA_VISIBLE 0
        000326: 01B4 SET_PLAYER_CONTROL 0 1
        000332: 016A DO_FADE 1000 1
        000339: 0A93 TERMINATE_THIS_CUSTOM_SCRIPT
        ; footer: 12 bytes at 341
        "
      `);
    });
  });
