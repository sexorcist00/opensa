  ...
  describe('positive cases', () => {
    ...
    it('builds deterministically and emits the committed listing (the review surface)', () => {
      ...
      expect(first.listing).toMatchInlineSnapshot(`
        ...
        000303: 04BB SET_AREA_VISIBLE 2@
        000308: 02E4 LOAD_CUTSCENE 0@s
        000313: 0006 SET_LVAR_INT 32@ 0
        000320: 00D6 IF 1
        000324: 06B9 NOT HAS_CUTSCENE_LOADED
        000326: 0019 NOT IS_INT_LVAR_GREATER_THAN_NUMBER 32@ 15000
        000334: 004D GOTO_IF_FALSE -352
        000341: 0001 WAIT 100
        000345: 0002 GOTO -320
        000352: 00D6 IF 0
        000356: 06B9 HAS_CUTSCENE_LOADED
        000358: 004D GOTO_IF_FALSE -415
        000365: 02E7 START_CUTSCENE
        000367: 016A DO_FADE 1000 1
        000374: 0006 SET_LVAR_INT 32@ 0
        000381: 00D6 IF 1
        000385: 02E9 NOT HAS_CUTSCENE_FINISHED
        000387: 0019 NOT IS_INT_LVAR_GREATER_THAN_NUMBER 32@ 300000
        000397: 004D GOTO_IF_FALSE -415
        000404: 0001 WAIT 0
        000408: 0002 GOTO -381
        000415: 016A DO_FADE 0 0
        000421: 02EA CLEAR_CUTSCENE
        000423: 02EB RESTORE_CAMERA_JUMPCUT
        000425: 0373 SET_CAMERA_BEHIND_PLAYER
        000427: 04BB SET_AREA_VISIBLE 0
        000431: 01B4 SET_PLAYER_CONTROL 0 1
        000437: 016A DO_FADE 1000 1
        000444: 0A93 TERMINATE_THIS_CUSTOM_SCRIPT
        ; footer: 12 bytes at 446
        "
      `);
    });
  });
