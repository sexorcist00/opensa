  ...
  describe('positive cases', () => {
    ...
    it('builds deterministically and emits the committed listing (the review surface)', () => {
      ...
      expect(first.listing).toMatchInlineSnapshot(`
        ...
        000530: 00D6 IF 0
        000534: 0039 IS_INT_LVAR_EQUAL_TO_NUMBER 4@ 1
        000541: 004D GOTO_IF_FALSE -609
        000548: 000B ADD_VAL_TO_FLOAT_LVAR 7@ 1.0
        000558: 00A1 SET_CHAR_COORDINATES $12 5@ 6@ 7@
        000572: 04E4 REQUEST_COLLISION 5@ 6@
        000580: 03CB LOAD_SCENE 5@ 6@ 7@
        000591: 0395 CLEAR_AREA 5@ 6@ 7@ 300.0 1
        000609: 04BB SET_AREA_VISIBLE 2@
        000614: 02E4 LOAD_CUTSCENE 0@s
        000619: 0006 SET_LVAR_INT 32@ 0
        000626: 00D6 IF 1
        000630: 06B9 NOT HAS_CUTSCENE_LOADED
        000632: 0019 NOT IS_INT_LVAR_GREATER_THAN_NUMBER 32@ 15000
        000640: 004D GOTO_IF_FALSE -658
        000647: 0001 WAIT 100
        000651: 0002 GOTO -626
        000658: 00D6 IF 0
        000662: 06B9 HAS_CUTSCENE_LOADED
        000664: 004D GOTO_IF_FALSE -721
        000671: 02E7 START_CUTSCENE
        000673: 016A DO_FADE 1000 1
        000680: 0006 SET_LVAR_INT 32@ 0
        000687: 00D6 IF 1
        000691: 02E9 NOT HAS_CUTSCENE_FINISHED
        000693: 0019 NOT IS_INT_LVAR_GREATER_THAN_NUMBER 32@ 300000
        000703: 004D GOTO_IF_FALSE -721
        000710: 0001 WAIT 0
        000714: 0002 GOTO -687
        000721: 016A DO_FADE 0 0
        000727: 02EA CLEAR_CUTSCENE
        000729: 02EB RESTORE_CAMERA_JUMPCUT
        000731: 0373 SET_CAMERA_BEHIND_PLAYER
        000733: 04BB SET_AREA_VISIBLE 0
        000737: 01B4 SET_PLAYER_CONTROL 0 1
        000743: 016A DO_FADE 1000 1
        000750: 0A93 TERMINATE_THIS_CUSTOM_SCRIPT
        ; footer: 12 bytes at 752
        "
      `);
    });
  });
