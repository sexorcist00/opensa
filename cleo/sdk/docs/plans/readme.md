...
| 2   | [002 — Assembler core](002-assembler-core.md)             | the decoder's mirror: operand writer, labels/jumps, LVARs, native-call tails, trailer; corpus re-encode byte-identical       | planned |
