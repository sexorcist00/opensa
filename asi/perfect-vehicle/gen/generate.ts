 ...
 * (`@opensa/asi-sdk/render`). Run: `npm run gen -w @opensa/perfect-vehicle-asi`. The C++ framework never
 * hard-codes an address; it reads these tables.
 */
...
function main(): void {
  ...
  writeFileSync(out, renderHeader(CATALOGUE, SA_FINGERPRINT, { namespace: 'pv' }));
