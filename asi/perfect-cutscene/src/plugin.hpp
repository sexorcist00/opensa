#pragma once
// perfect-cutscene's plugin declaration — what this plugin hands to the SDK framework: its identity, its
// generated tables (adapted from `pc::gen`, the generator's output) and its apply entry point. This file is the
// ONLY place where the plugin's generated namespace meets the framework.
