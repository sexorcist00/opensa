...
export function StatusBar({ readout }: { readout: DispatchReadout | null }): ReactElement {
  if (!readout) {
    return (
  ...
  return (
    <div style={styles.statusBar}>
      ...
      <span style={{ marginLeft: 'auto' }}>pak {readout.buildTime}</span>
      <span>left-drag pan · right-drag orbit · wheel zoom · click select · right-click new call</span>
    </div>
  );
}
